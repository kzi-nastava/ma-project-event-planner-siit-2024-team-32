...
import com.example.eventplanner.databinding.ActivityDisplayCompanyInfoBinding;
import com.example.eventplanner.databinding.ActivityDisplayPersonalInfoBinding;
import com.example.eventplanner.fragments.DisplayCompanyInfoFragment;
import com.example.eventplanner.fragments.DisplayPersonalInfoFragment;
...
public class DisplayCompanyInfoActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityDisplayCompanyInfoBinding binding = ActivityDisplayCompanyInfoBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new DisplayCompanyInfoFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_five, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_five, newFragment);
