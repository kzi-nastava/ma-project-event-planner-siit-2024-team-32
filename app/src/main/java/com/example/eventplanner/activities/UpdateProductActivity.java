...
import com.example.eventplanner.databinding.ActivityUpdateProductBinding;
...
import com.example.eventplanner.fragments.UpdateProductFragment;
...
public class UpdateProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityUpdateProductBinding binding = ActivityUpdateProductBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            transaction.replace(R.id.fragment_container_update_product, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_update_product, newFragment);
