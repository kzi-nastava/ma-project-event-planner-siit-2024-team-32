...
import com.example.eventplanner.databinding.ActivityProductCreationBinding;
...
import com.example.eventplanner.fragments.ProductCreationFragment;
...
public class ProductCreationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityProductCreationBinding binding = ActivityProductCreationBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            transaction.replace(R.id.fragment_container_product_creation, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_product_creation, newFragment);
