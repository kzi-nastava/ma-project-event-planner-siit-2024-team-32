...
import com.example.eventplanner.databinding.ActivityDisplayProductsForSppBinding;
import com.example.eventplanner.databinding.ActivityEventCreationBinding;
import com.example.eventplanner.fragments.DisplayProductsForSppFragment;
...
public class DisplayProductsForSppActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityDisplayProductsForSppBinding binding = ActivityDisplayProductsForSppBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new DisplayProductsForSppFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_display_products, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_display_products, newFragment);
