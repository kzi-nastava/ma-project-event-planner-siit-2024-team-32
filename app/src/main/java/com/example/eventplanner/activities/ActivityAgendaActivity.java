...
import com.example.eventplanner.databinding.ActivityAgendaBinding;
import com.example.eventplanner.databinding.ActivityEventCreationBinding;
import com.example.eventplanner.fragments.ActivityAgendaFragment;
...
public class ActivityAgendaActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityAgendaBinding binding = ActivityAgendaBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new ActivityAgendaFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_activity_agenda, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_activity_agenda, newFragment);
