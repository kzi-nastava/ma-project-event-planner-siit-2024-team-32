...
import com.example.eventplanner.databinding.ActivityStatisticsBinding;
...
import com.example.eventplanner.fragments.StatisticsFragment;
...
public class StatisticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            transaction.replace(R.id.fragment_container_statistics, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_statistics, newFragment);
