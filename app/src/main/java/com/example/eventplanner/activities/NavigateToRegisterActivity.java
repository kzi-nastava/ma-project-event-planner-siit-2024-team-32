...
import com.example.eventplanner.databinding.ActivityNavigateToRegisterBinding;
...
import com.example.eventplanner.fragments.NavigateToRegisterFragment;
...
public class NavigateToRegisterActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityNavigateToRegisterBinding binding = ActivityNavigateToRegisterBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new NavigateToRegisterFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_ten, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_ten, newFragment);
