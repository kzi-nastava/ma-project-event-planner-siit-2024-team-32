...
public class UpdatePersonalInformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityUpdatePersonalInformationBinding binding = ActivityUpdatePersonalInformationBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new UpdatePersonalInformationFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_two, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_two, newFragment);
