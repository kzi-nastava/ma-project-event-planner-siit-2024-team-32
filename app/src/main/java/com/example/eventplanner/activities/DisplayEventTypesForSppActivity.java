...
import com.example.eventplanner.databinding.ActivityDisplayEventTypesForSppBinding;
import com.example.eventplanner.databinding.ActivityRegisterBinding;
import com.example.eventplanner.fragments.DisplayEventTypesForSppFragment;
...
public class DisplayEventTypesForSppActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        ActivityDisplayEventTypesForSppBinding binding = ActivityDisplayEventTypesForSppBinding.inflate(getLayoutInflater());
        ...
        if (savedInstanceState == null) {
            ...
            Fragment fragment = new DisplayEventTypesForSppFragment();

            // Kreirajte fragment transaction i dodajte fragment u container
            FragmentTransaction transaction = getSupportFragmentManager().beginTransaction();
            transaction.replace(R.id.fragment_container_eleven, fragment);  // R.id.fragment_container je ID container-a
    ...
    private void replaceFragment(Fragment newFragment) {
        ...
        fragmentTransaction.replace(R.id.fragment_container_eleven, newFragment);
