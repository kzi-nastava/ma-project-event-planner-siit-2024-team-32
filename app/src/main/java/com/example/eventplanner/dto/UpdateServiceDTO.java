...
public class UpdateServiceDTO {
    ...
    public UpdateServiceDTO(Long id, int serviceAndProductCategory, float price, int serviceAndProductProvider, String name, String description, String specifics, float discount, ServiceStatus serviceStatus, String[] servicePictures, int[] applicableEventTypes, AppointmentType appointmentType, int appointmentDurationMinutes, int minimumAppointmentDurationMinutes, int maximumAppointmentDurationMinutes, int reservationDeadLineHours, int cancelationDeadlineHours) {
        this.id = id;
